...
### Etc
  ...
  [wiki~codereading~](https://github.com/Cj-bc/wiki_codereading)                  Wiki for code reading                                [wiki~default~](https://github.com/Cj-bc/wiki_default)        Default Wiki
  ...
  [win~init~](https://github.com/Cj-bc/win_init)                                  Init bat file for when I borrow Windows PC           [ctf](https://github.com/Cj-bc/ctf)                           CTF solving memo
  ------------------------------------------------------------------------------- ---------------------------------------------------- ------------------------------------------------------------- --------------------------------
...
### SNS
  ...
  Misskey                                       [=@cj_bc_sd_@misskey.io=](https://misskey.io/@cj_bc_sd), [\@cj~bcsd~\@misskey.neos.love](https://misskey.neos.love/@cj_bc_sd)
  --------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------
